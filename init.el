...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (tide typescript-mode git-timemachine flycheck-ycmd company-ycmd use-package helm-tramp ac-php rust-mode php-mode web-beautify web-mode ox-twbs fcitx helm-projectile flycheck dashboard ace-popup-menu company-anaconda company virtualenvwrapper anaconda-mode evil-magit magit rainbow-delimiters neotree org-bullets org-evil solarized-theme which-key helm evil))))
(custom-set-faces
